...
/* ./.libs/lt-t-do-exceptions-work-at-all-with-this-compiler.c - temporary wrapper executable for .libs/t-do-exceptions-work-at-all-with-this-compiler.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-do-exceptions-work-at-all-with-this-compiler program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/home/gregwar/git/mxe/tmp-gmp-i686-w64-mingw32.shared.posix/gmp-6.1.2/.libs;/home/gregwar/git/mxe/usr/lib/gcc/i686-w64-mingw32.shared.posix/5.4.0;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/home/gregwar/git/mxe/tmp-gmp-i686-w64-mingw32.shared.posix/gmp-6.1.2/.libs;/home/gregwar/git/mxe/usr/lib/gcc/i686-w64-mingw32.shared.posix/5.4.0;/home/gregwar/git/mxe/usr/i686-w64-mingw32.shared.posix/lib;/home/gregwar/git/mxe/usr/i686-w64-mingw32.shared.posix/bin;";
const char * TARGET_PROGRAM_NAME = "t-do-exceptions-work-at-all-with-this-compiler.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-do-exceptions-work-at-all-with-this-compiler - temporary wrapper script for", f);
  fputs (" .libs/t-do-exceptions-work-at-all-with-this-compiler.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-do-exceptions-work-at-all-with-this-compiler program cannot be directly", f);
  fputs (" executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../../libgmpxx.la /home/gregwar/git/mxe/tmp-gmp-i686-w64-mi", f);
  fputs ("ngw32.shared.posix/gmp-6.1.2/libgmp.la /home/gregwar/git/mxe/usr/lib/gcc/i686-w", f);
  fputs ("64-mingw32.shared.posix/5.4.0/libstdc++.la ../../libgmp.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"t-do-exceptions-work-at-all-with-this-compiler.exe:t-do-exceptions-wo", f);
  fputs ("rk-at-all-with-this-compiler:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-do-exceptions-work-at-all-with-this-compiler.exe:t-do-exceptions-w", f);
  fputs ("ork-at-all-with-this-compiler:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-do-exceptions-work-at-all-with-this-compiler.exe:t-do-exceptio", f);
  fputs ("ns-work-at-all-with-this-compiler:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='t-do-exceptions-work-at-all-with-this-compiler.exe'\n", f);
  ...
  fputs ("    PATH=/home/gregwar/git/mxe/tmp-gmp-i686-w64-mingw32.shared.posix/gmp-6.1.2/", f);
  fputs (".libs:/home/gregwar/git/mxe/usr/lib/gcc/i686-w64-mingw32.shared.posix/5.4.0:/ho", f);
  fputs ("me/gregwar/git/mxe/usr/i686-w64-mingw32.shared.posix/lib:/home/gregwar/git/mxe/", f);
  fputs ("usr/i686-w64-mingw32.shared.posix/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/gregwar/git/mxe/tmp-gmp-i686-w64-mingw32.shared.posix/gmp-6.1.2", f);
  fputs ("/.libs:/home/gregwar/git/mxe/usr/lib/gcc/i686-w64-mingw32.shared.posix/5.4.0:$P", f);
  fputs ("ATH\"\n", f);
  fputs ("\n", f);
