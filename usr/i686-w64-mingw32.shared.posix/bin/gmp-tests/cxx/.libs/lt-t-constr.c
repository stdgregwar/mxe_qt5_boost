...
/* ./.libs/lt-t-constr.c - temporary wrapper executable for .libs/t-constr.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-constr program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "t-constr.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-constr - temporary wrapper script for .libs/t-constr.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-constr program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"t-constr.exe:t-constr:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-constr.exe:t-constr:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-constr.exe:t-constr:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
