...
/* ./.libs/lt-t-lcm.c - temporary wrapper executable for .libs/t-lcm.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-lcm program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "t-lcm.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-lcm - temporary wrapper script for .libs/t-lcm.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-lcm program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"t-lcm.exe:t-lcm:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-lcm.exe:t-lcm:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-lcm.exe:t-lcm:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
