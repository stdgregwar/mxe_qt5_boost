...
/* ./.libs/lt-t-sqrtrem.c - temporary wrapper executable for .libs/t-sqrtrem.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-sqrtrem program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "t-sqrtrem.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-sqrtrem - temporary wrapper script for .libs/t-sqrtrem.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-sqrtrem program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"t-sqrtrem.exe:t-sqrtrem:$LINENO: libtool wrapper (GNU libtool) 2.4.6\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-sqrtrem.exe:t-sqrtrem:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-sqrtrem.exe:t-sqrtrem:$LINENO: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
