...
/* ./.libs/lt-t-set_str.c - temporary wrapper executable for .libs/t-set_str.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-set_str program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "t-set_str.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-set_str - temporary wrapper script for .libs/t-set_str.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-set_str program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"t-set_str.exe:t-set_str:$LINENO: libtool wrapper (GNU libtool) 2.4.6\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-set_str.exe:t-set_str:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-set_str.exe:t-set_str:$LINENO: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
