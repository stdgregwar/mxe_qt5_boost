...
/* ./.libs/lt-t-popcount.c - temporary wrapper executable for .libs/t-popcount.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-popcount program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "t-popcount.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-popcount - temporary wrapper script for .libs/t-popcount.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-popcount program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"t-popcount.exe:t-popcount:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-popcount.exe:t-popcount:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-popcount.exe:t-popcount:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
