...
/* ./.libs/lt-t-primorial_ui.c - temporary wrapper executable for .libs/t-primorial_ui.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-primorial_ui program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/home/gregwar/git/mxe/tmp-gmp-i686-w64-mingw32.shared.posix/gmp-6.1.2/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/home/gregwar/git/mxe/tmp-gmp-i686-w64-mingw32.shared.posix/gmp-6.1.2/.libs;/home/gregwar/git/mxe/usr/i686-w64-mingw32.shared.posix/lib;/home/gregwar/git/mxe/usr/i686-w64-mingw32.shared.posix/bin;";
const char * TARGET_PROGRAM_NAME = "t-primorial_ui.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-primorial_ui - temporary wrapper script for .libs/t-primorial_ui.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-primorial_ui program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' /home/gregwar/git/mxe/tmp-gmp-i686-w64-mingw32.shared.posix", f);
  fputs ("/gmp-6.1.2/libgmp.la ../../libgmp.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"t-primorial_ui.exe:t-primorial_ui:$LINENO: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-primorial_ui.exe:t-primorial_ui:$LINENO: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-primorial_ui.exe:t-primorial_ui:$LINENO: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='t-primorial_ui.exe'\n", f);
  ...
  fputs (".libs:/home/gregwar/git/mxe/usr/i686-w64-mingw32.shared.posix/lib:/home/gregwar", f);
  fputs ("/git/mxe/usr/i686-w64-mingw32.shared.posix/bin:$PATH\n", f);
  fputs ("\n", f);
