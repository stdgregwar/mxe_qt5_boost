...
/* ./.libs/lt-t-sqrmod_bnm1.c - temporary wrapper executable for .libs/t-sqrmod_bnm1.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-sqrmod_bnm1 program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "t-sqrmod_bnm1.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-sqrmod_bnm1 - temporary wrapper script for .libs/t-sqrmod_bnm1.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-sqrmod_bnm1 program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"t-sqrmod_bnm1.exe:t-sqrmod_bnm1:$LINENO: libtool wrapper (GNU libtool", f);
  fputs (") 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-sqrmod_bnm1.exe:t-sqrmod_bnm1:$LINENO: newargv[$lt_dump_args_N]: $", f);
  fputs ("lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-sqrmod_bnm1.exe:t-sqrmod_bnm1:$LINENO: newargv[0]: $progdir/$p", f);
  fputs ("rogram\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='t-sqrmod_bnm1.exe'\n", f);
