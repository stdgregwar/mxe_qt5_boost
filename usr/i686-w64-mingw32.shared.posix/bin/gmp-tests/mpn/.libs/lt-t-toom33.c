...
/* ./.libs/lt-t-toom33.c - temporary wrapper executable for .libs/t-toom33.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-toom33 program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "t-toom33.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-toom33 - temporary wrapper script for .libs/t-toom33.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-toom33 program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"t-toom33.exe:t-toom33:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-toom33.exe:t-toom33:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-toom33.exe:t-toom33:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
