...
/* ./.libs/lt-t-toom4-sqr.c - temporary wrapper executable for .libs/t-toom4-sqr.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-toom4-sqr program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "t-toom4-sqr.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-toom4-sqr - temporary wrapper script for .libs/t-toom4-sqr.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-toom4-sqr program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"t-toom4-sqr.exe:t-toom4-sqr:$LINENO: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-toom4-sqr.exe:t-toom4-sqr:$LINENO: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-toom4-sqr.exe:t-toom4-sqr:$LINENO: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
