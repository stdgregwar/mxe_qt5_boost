...
/* ./.libs/lt-t-hightomask.c - temporary wrapper executable for .libs/t-hightomask.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-hightomask program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "t-hightomask.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-hightomask - temporary wrapper script for .libs/t-hightomask.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-hightomask program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"t-hightomask.exe:t-hightomask:$LINENO: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-hightomask.exe:t-hightomask:$LINENO: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-hightomask.exe:t-hightomask:$LINENO: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='t-hightomask.exe'\n", f);
