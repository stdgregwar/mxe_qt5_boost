...
enum opt_code
{
  ...
  OPT_municode = 1275,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1276,          /* -muse-libstdc-wrappers */
  OPT_mveclibabi_ = 1277,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1278,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1279,                    /* -mvzeroupper */
  OPT_mwin32 = 1280,                         /* -mwin32 */
  OPT_mwindows = 1281,                       /* -mwindows */
  OPT_mx32 = 1282,                           /* -mx32 */
  OPT_mxop = 1283,                           /* -mxop */
  OPT_mxsave = 1284,                         /* -mxsave */
  OPT_mxsavec = 1285,                        /* -mxsavec */
  OPT_mxsaveopt = 1286,                      /* -mxsaveopt */
  OPT_mxsaves = 1287,                        /* -mxsaves */
  OPT_n = 1288,                              /* -n */
  OPT_no_canonical_prefixes = 1289,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1290,              /* -no-integrated-cpp */
  OPT_no_pthread = 1291,                     /* -no-pthread */
  OPT_nocpp = 1292,                          /* -nocpp */
  OPT_nodefaultlibs = 1293,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1294,                   /* -nostartfiles */
  OPT_nostdinc = 1295,                       /* -nostdinc */
  OPT_nostdinc__ = 1296,                     /* -nostdinc++ */
  OPT_nostdlib = 1297,                       /* -nostdlib */
  OPT_o = 1298,                              /* -o */
  OPT_p = 1299,                              /* -p */
  OPT_pass_exit_codes = 1300,                /* -pass-exit-codes */
  /* OPT_pedantic = 1301, */                 /* -pedantic */
  OPT_pedantic_errors = 1302,                /* -pedantic-errors */
  OPT_pg = 1303,                             /* -pg */
  OPT_pie = 1304,                            /* -pie */
  OPT_pipe = 1305,                           /* -pipe */
  OPT_posix = 1306,                          /* -posix */
  OPT_print_file_name_ = 1307,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1308,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1309,          /* -print-multi-directory */
  OPT_print_multi_lib = 1310,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1311,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1312,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1313,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1314,               /* -print-prog-name= */
  OPT_print_search_dirs = 1315,              /* -print-search-dirs */
  OPT_print_sysroot = 1316,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1317,   /* -print-sysroot-headers-suffix */
  OPT_pthread = 1318,                        /* -pthread */
  OPT_quiet = 1319,                          /* -quiet */
  OPT_r = 1320,                              /* -r */
  OPT_remap = 1321,                          /* -remap */
  OPT_s = 1322,                              /* -s */
  OPT_s_bc_abi = 1323,                       /* -s-bc-abi */
  OPT_save_temps = 1324,                     /* -save-temps */
  OPT_save_temps_ = 1325,                    /* -save-temps= */
  OPT_shared = 1326,                         /* -shared */
  OPT_shared_libgcc = 1327,                  /* -shared-libgcc */
  /* OPT_specs = 1328, */                    /* -specs */
  OPT_specs_ = 1329,                         /* -specs= */
  OPT_static = 1330,                         /* -static */
  OPT_static_libasan = 1331,                 /* -static-libasan */
  OPT_static_libgcc = 1332,                  /* -static-libgcc */
  OPT_static_libgcj = 1333,                  /* -static-libgcj */
  OPT_static_libgfortran = 1334,             /* -static-libgfortran */
  OPT_static_libgo = 1335,                   /* -static-libgo */
  OPT_static_liblsan = 1336,                 /* -static-liblsan */
  OPT_static_libmpx = 1337,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1338,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1339,               /* -static-libstdc++ */
  OPT_static_libtsan = 1340,                 /* -static-libtsan */
  OPT_static_libubsan = 1341,                /* -static-libubsan */
  /* OPT_std_c__03 = 1342, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1343, */                /* -std=c++0x */
  OPT_std_c__11 = 1344,                      /* -std=c++11 */
  OPT_std_c__14 = 1345,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1346, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1347, */                /* -std=c++1y */
  OPT_std_c__1z = 1348,                      /* -std=c++1z */
  OPT_std_c__98 = 1349,                      /* -std=c++98 */
  OPT_std_c11 = 1350,                        /* -std=c11 */
  /* OPT_std_c1x = 1351, */                  /* -std=c1x */
  /* OPT_std_c89 = 1352, */                  /* -std=c89 */
  OPT_std_c90 = 1353,                        /* -std=c90 */
  OPT_std_c99 = 1354,                        /* -std=c99 */
  /* OPT_std_c9x = 1355, */                  /* -std=c9x */
  OPT_std_f2003 = 1356,                      /* -std=f2003 */
  OPT_std_f2008 = 1357,                      /* -std=f2008 */
  OPT_std_f2008ts = 1358,                    /* -std=f2008ts */
  OPT_std_f95 = 1359,                        /* -std=f95 */
  OPT_std_gnu = 1360,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1361, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1362, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1363,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1364,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1365, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1366, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1367,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1368,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1369,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1370, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1371, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1372,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1373,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1374, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1375, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1376,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1377, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1378, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1379, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1380,                     /* -std=legacy */
  OPT_symbolic = 1381,                       /* -symbolic */
  OPT_t = 1382,                              /* -t */
  OPT_time = 1383,                           /* -time */
  OPT_time_ = 1384,                          /* -time= */
  OPT_traditional = 1385,                    /* -traditional */
  OPT_traditional_cpp = 1386,                /* -traditional-cpp */
  OPT_trigraphs = 1387,                      /* -trigraphs */
  OPT_u = 1388,                              /* -u */
  OPT_undef = 1389,                          /* -undef */
  OPT_v = 1390,                              /* -v */
  OPT_version = 1391,                        /* -version */
  OPT_w = 1392,                              /* -w */
  OPT_wrapper = 1393,                        /* -wrapper */
  OPT_x = 1394,                              /* -x */
  OPT_z = 1395,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
